...
<form action="mostrar/actualizar.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
	<table class="formulario">
			...
			<tr><td>Alias</td><td class="f1"><?php echo $row[3];?></td><td><input type="text" name="alias" placeholder="Nuevo Alias" id="editar_alias"></td></tr>
			<tr><td>Nacionalidad</td><td class="f1"><?php echo $row[4];?></td><td><input type="text" name="nacionalidad" placeholder="Nueva Nacionalidad" id="editar_nacionalidad"></td></tr>
			<tr><td>Fecha de Nacimiento</td><td class="f1"><?php echo $row[5];?></td><td><input type="date" name="fecha_nacimiento" placeholder="Nueva Fecha Nacimiento" id="editar_fecha_nacimiento"></td></tr>
			<tr><td>Lugar de Nacimiento</td><td class="f1"><?php echo $row[6];?></td><td><input type="text" name="lugar_nacimiento" placeholder="Nuevo Lugar Nacimiento" id="editar_lugar_nacimiento"></td></tr>
			<tr><td>Sexo</td><td class="f1"><?php echo $row[7];?></td><td><select name="sexo" id="editar_sexo">
					<option >Seleccione</option>
					<option value="M">Masculino</option>
					<option value="F">Femenino</option>
			</select></tr>
			<tr><td>Ocupacion</td><td class="f1"><?php echo $row[9];?></td><td><input type="text" name="ocupacion" placeholder="Nueva Ocupacion" id="editar_ocupacion"></td></tr>
			...
			<tr><td>Foto</td><td class="f1"><img src='/gnb/agregar/imagenes/<?php echo $row[8]?>' width='150' height='150'></td><td><input type="file" name="imagen" id="editar_foto"></td></tr>
